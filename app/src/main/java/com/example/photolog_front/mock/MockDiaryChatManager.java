...
public class MockDiaryChatManager {
    ...
    public static String buildDiary(List<ChatMessageEntity> messages) {
        ...
        return "오늘은 바닷가 산책로에서의 순간을 사진으로 남겼다.\n"
                + "부모님 그리고 동생과 함께 시간을 보냈고, "
                + "그날의 분위기는 날씨도 맑고 바람도 시원해서 아주 좋았다.\n"
                + "그 순간 나는 가족들과 함께해서 마음이 편안하고 행복하다는 감정을 느꼈다.\n"
                + "특히 다같이 바다를 바라보면서 사진 찍고 웃었던 일이 가장 기억에 남는다.\n"
